...
import { DungeonWall, type DungeonWallDirection } from "../dungeon-wall/dungeon-wall";
import { DungeonFloor } from "../dungeon-floor/dungeon-floor";
import { type MapChipType } from "../../../../types/map-state-types/map-state.types";
...
export class DungeonMapChip extends PIXI.Container {
  constructor(props: DungeonMapChipProps) {
    ...
    const floor = new DungeonFloor({ chipSize, visible: chip.floor !== "none" });
    this.addChild(floor);
